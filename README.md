...
- **[iterative-document-review](skills/iterative-document-review/SKILL.md)** — Multi-pass, converge-to-clean review of specs, PRDs, RFCs, architecture docs, and similar structured documents. Runs review passes as isolated subagents, auto-fixes what it can, batches questions for the user, and re-reviews until no Critical/High/Medium findings remain.
...
See [`skills/iterative-document-review/SKILL.md`](skills/iterative-document-review/SKILL.md) for the full process, severity definitions, and worked classification examples.
